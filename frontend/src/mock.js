...
export const categories = [
  {
    name: "T-shirts",
    icon: "Shirt",
    description: "Premium quality cotton and blended t-shirts"
  },
  {
    name: "Sportswear",
    icon: "Activity",
    description: "Performance-focused athletic apparel"
  },
  {
    name: "Gym Wear",
    icon: "Dumbbell",
    description: "Comfortable and durable fitness clothing"
  },
  {
    name: "Gloves",
    icon: "Hand",
    description: "Professional training and sports gloves"
  }
];
...
export const companyInfo = {
  ...
  description: "KK-TRUST COMP is a leading export company based in Pakistan, specializing in high-quality T-shirts, sportswear, gym wear, and gloves. With years of experience in international trade, we deliver excellence to clients worldwide.",
  mission: "To provide world-class textile products that meet international standards while maintaining competitive pricing and reliable delivery schedules.",
  vision: "To become the most trusted name in textile exports from Pakistan, known for quality, reliability, and customer satisfaction.",
  values: [
    "Quality Assurance",
    "Timely Delivery",
  ...
  stats: [
    ...
    { label: "Products Exported", value: "5M+" },
